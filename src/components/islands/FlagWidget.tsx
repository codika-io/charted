      ...
      {open && (
        ...
        >
          ...
          >
            {success ? (
              <div className="p-6">
                <h2 id="flag-title" className="text-xl mb-2">Thanks — flag received</h2>
                <p className="text-sm text-surface-600 mb-4">
                  We opened a tracking issue. A maintainer will review it shortly.
                </p>
              ...
              <form onSubmit={submit} className="p-6">
                <header className="mb-4">
                  <h2 id="flag-title" className="text-xl mb-1">Flag an issue</h2>
