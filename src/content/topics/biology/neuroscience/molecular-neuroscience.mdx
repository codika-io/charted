...
description: "Molecular machines of neural function — receptors, transporters, scaffolds, signaling."
...
**Molecular Neuroscience** sits within neuroscience and addresses molecular machines of neural function — receptors, transporters, scaffolds, signaling. The page below sketches the conceptual scope of the area, the methodological tools it relies on, and the recent literature anchoring its current frontier.
...
*Kandel, Principles of Neural Science* is a standard reference for the foundations covered here, used across the field to anchor terminology, canonical models, and the relationships between sub-areas of molecular neuroscience. Treat it as the entry point to which the more specialised work below adds frontier detail.

*Purves, Neuroscience* is a standard reference for the foundations covered here, used across the field to anchor terminology, canonical models, and the relationships between sub-areas of molecular neuroscience. Treat it as the entry point to which the more specialised work below adds frontier detail.
