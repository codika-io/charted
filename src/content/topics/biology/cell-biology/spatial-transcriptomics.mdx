...
description: "In-situ and array-based methods that preserve tissue context for transcriptome profiling."
...
**Spatial Transcriptomics** sits within cell biology and addresses in-situ and array-based methods that preserve tissue context for transcriptome profiling. The page below sketches the conceptual scope of the area, the methodological tools it relies on, and the recent literature anchoring its current frontier.
