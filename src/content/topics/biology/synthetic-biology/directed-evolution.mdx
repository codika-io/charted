...
description: "Iterative mutation and selection to evolve proteins and pathways with new functions."
...
**Directed Evolution** sits within synthetic biology and addresses iterative mutation and selection to evolve proteins and pathways with new functions. The page below sketches the conceptual scope of the area, the methodological tools it relies on, and the recent literature anchoring its current frontier.
