...
description: "Digestion, absorption, and enteric nervous system control."
...
**Gastrointestinal Physiology** sits within physiology and addresses digestion, absorption, and enteric nervous system control. The page below sketches the conceptual scope of the area, the methodological tools it relies on, and the recent literature anchoring its current frontier.
