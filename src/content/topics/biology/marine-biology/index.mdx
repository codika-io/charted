...
**Marine Biology** sits within biology and addresses biology of marine organisms and ecosystems. The page below sketches the conceptual scope of the area, the methodological tools it relies on, and the recent literature anchoring its current frontier.
