...
description: "Reef ecology, coral bleaching, and reef resilience."
...
**Coral Reef Biology** sits within marine biology and addresses reef ecology, coral bleaching, and reef resilience. The page below sketches the conceptual scope of the area, the methodological tools it relies on, and the recent literature anchoring its current frontier.
