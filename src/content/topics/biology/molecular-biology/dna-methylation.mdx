...
description: "Cytosine methylation patterns, DNMTs, TETs, and methylome landscapes."
...
**DNA Methylation** sits within epigenetics and addresses cytosine methylation patterns, dnmts, tets, and methylome landscapes. The page below sketches the conceptual scope of the area, the methodological tools it relies on, and the recent literature anchoring its current frontier.
