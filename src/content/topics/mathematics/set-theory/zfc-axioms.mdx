...
description: >-
  The Zermelo-Fraenkel axioms with Choice — the standard foundation of
  mathematics.
...
prerequisites:
  - mathematics/set-theory/naive-set-theory
  - mathematics/set-theory/functions-and-cardinality
status: archived
author: agent
lastEditedBy: agent
